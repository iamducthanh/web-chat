...
function sweetWrong(title, message) {
    sweetAlert(title, message)
}

function sweetMessage(message) {
    swal(message)
}

function sweetText(title, message) {
    swal(title, message)
}

function sweetSuccess(title, message) {
...
function sweetImageMessage(title, message, linkImage) {
    swal({ title: title, text: message, imageUrl: linkImage })
}

function sweetHTML(title, textHTML) {
    swal({ title: title, text: textHTML, html: !0 })
}

function sweetAutoClose(title, message) {
    swal({
        title: title,
        text: message,
        timer: 2e3,
...
function sweetPrompt(title, message, textPlacehoder, messageError) {
    swal({
        title: title,
        text: message,
        type: "input",
        ...
        inputPlaceholder: textPlacehoder
    }, function (e) {
        return !1 !== e && ("" === e ? (swal.showInputError(messageError), !1) : void swal("Hey !!", "You wrote: " + e, "success"))
    })
}

function sweetAjax(title, message) {
    swal({
        title: title,
        text: message,
        type: "info",
